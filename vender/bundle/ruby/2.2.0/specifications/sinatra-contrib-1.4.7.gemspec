...
Gem::Specification.new do |s|
  ...
  s.authors = ["Konstantin Haase".freeze, "Zachary Scott".freeze, "Gabriel Andretta".freeze, "Trevor Bramble".freeze, "Katrina Owen".freeze, "Ashley Williams".freeze, "Nicolas Sanguinetti".freeze, "Hrvoje \u{160}imi\u{107}".freeze, "Masahiro Fujiwara".freeze, "Rafael Magana".freeze, "Vipul A M".freeze, "ashley williams".freeze, "Jack Chu".freeze, "Sumeet Singh".freeze, "Ilya Shindyapin".freeze, "lest".freeze, "Jake Worth".freeze, "Kashyap".freeze, "Matt Lyon".freeze, "Matthew Conway".freeze, "Meck".freeze, "Michi Huber".freeze, "Nic Benders".freeze, "Patricio Mac Adden".freeze, "Reed Lipman".freeze, "Samy Dindane".freeze, "Sergey Nartimov".freeze, "Thibaut Sacreste".freeze, "Uchio KONDO".freeze, "Will Bailey".freeze, "mono".freeze, "Adrian Paca\u{142}a".freeze, "undr".freeze, "Aish".freeze, "Alexey Chernenkov".freeze, "Andrew Crump".freeze, "Anton Davydov".freeze, "Bo Jeanes".freeze, "David Asabina".freeze, "Eliot Shepard".freeze, "Eric Marden".freeze, "Gray Manley".freeze, "Guillaume Bouteille".freeze, "Jamie Hodge".freeze, "Julie Ng".freeze, "Koichi Sasada".freeze, "Kyle Lacy".freeze, "Lars Vonk".freeze, "Martin Frost".freeze, "Mathieu Allaire".freeze]
  s.date = "2016-04-11"
